...
func _move_win_to_rand():
	...
	gamewin_target_position.x = randi_range(display_pos.x, display_siz.x - 400) + display_pos.x;
	gamewin_target_position.y = randi_range(display_pos.y, display_siz.y - 400) + display_pos.y;
